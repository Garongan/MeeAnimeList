...
const Navbar = () => {
  ...
  return (
    <header className={`${isScrolled ? 'top-5 z-10 container' : 'top-0 mx-0 px-0'} sticky transition-all duration-300`}>
      <div className={`${isScrolled} ? bg-color-accent/75 backdrop-blur-sm rounded-lg : bg-color-accent shadow-md shadow-color-dark/30 transition-all duration-300`}>
